...
public class TreeDemo extends JPanel
    ...
    private DefaultMutableTreeNode createNodes(ASTNode tree){
        if(tree==null||tree.isNil())
            return null;
        DefaultMutableTreeNode thisNode=new DefaultMutableTreeNode(tree.toString()+":"+tree.getType());
